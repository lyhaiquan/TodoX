...
const TaskCard = ({ task, index, handleTaskChanged }) => {
  ...
  return (
    <Card
        className={cn(
          "p-4 bg-gradient-card border-0 shadow-custom-md transition-all duration-200 group",
          "force-animate opacity-0", // Dùng class thuần ở đây
          task.status === "complete" && "opacity-75"
        )}
        style={{ 
          animationDelay: `${index * 150}ms`, // Tăng hẳn lên 150ms để nhìn cho rõ
